...
export default function BoardLayout({
  ...
  return (
    <div className="bg-background text-on-surface h-screen flex flex-col overflow-hidden">
      <nav className="bg-surface-container-lowest font-label-sm font-medium fixed top-0 w-full z-50 border-b border-surface-variant shadow-[0_1px_2px_rgba(0,0,0,0.02)] flex justify-between items-center px-[24px] h-[64px]">
        ...
        <div className="flex items-center gap-md">
          ...
          <div className="flex gap-sm">
            <button
              type="button"
              className="text-outline hover:text-on-surface transition-colors w-[32px] h-[32px] flex items-center justify-center rounded-full hover:bg-surface-container"
          ...
          <div
            className="w-[32px] h-[32px] rounded-full border border-surface-variant object-cover flex items-center justify-center font-body-md font-semibold"
      ...
      <div className="flex flex-1 pt-[64px] h-full overflow-hidden">
        <aside className="bg-surface-container-lowest font-body-md fixed left-0 top-[64px] h-[calc(100vh-64px)] w-[256px] rounded-none border-r border-surface-variant flex flex-col py-[16px] gap-[8px] z-40 hidden md:flex">
          ...
          <nav className="flex-1 px-[8px] flex flex-col gap-[4px]">
            <a
              className="flex items-center gap-md px-[12px] py-[8px] rounded-lg bg-primary/10 text-primary font-semibold border-l-4 border-primary transition-all active:translate-x-1 duration-150"
              href="#"
            >
            ...
            <a
              className="flex items-center gap-md px-[12px] py-[8px] rounded-lg text-on-surface-variant hover:bg-surface-container hover:text-on-surface transition-all active:translate-x-1 duration-150"
              href="#"
            >
            ...
            <a
              className="flex items-center gap-md px-[12px] py-[8px] rounded-lg text-on-surface-variant hover:bg-surface-container hover:text-on-surface transition-all active:translate-x-1 duration-150 mt-auto"
              href="#"
            >
        ...
        <main className="flex-1 md:ml-[256px] h-full overflow-hidden bg-background flex flex-col">
          ...
          <div className="bg-surface-container-lowest border-t border-surface-variant p-md flex flex-wrap items-center gap-md">
            <div className="flex-1 min-w-[200px] relative">
              ...
              <input
                className="w-full pl-[36px] pr-sm py-[8px] bg-surface-container-low border border-surface-variant rounded-lg font-body-md text-on-surface focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary placeholder:text-outline-variant"
